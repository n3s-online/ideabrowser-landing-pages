...
export function UrgencySection() {
  ...
  const handleWaitlistSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (email) {
      alert(`Welcome to our exclusive early access list! We'll contact you at ${email} with your early access details.`);
      setEmail("");
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            We're launching Q1 2025 with exclusive early access for 50 forward-thinking SaaS founders. 
            Don't miss your chance to transform your billing operations.
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-2xl p-8 mb-12 max-w-4xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Secure your spot before it's too late</p>
          </div>
          ...
          <form onSubmit={handleWaitlistSubmit} className="max-w-md mx-auto">
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              />
              <Button type="submit" size="lg" className="h-12 bg-red-600 hover:bg-red-700">
                Reserve My Spot
              </Button>
            </div>
          </form>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Beta Launch</h4>
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Public Launch</h4>
        ...
        <div className="text-center mt-12">
          <div className="bg-red-600 text-white rounded-lg p-6 max-w-2xl mx-auto">
            ...
            <h3 className="text-xl font-bold mb-2">Don't Wait - Spots Are Going Fast!</h3>
            <p className="text-red-100 text-sm">
              Over 300 founders have already expressed interest. Only {spotsRemaining} early access spots remain. 
              Secure yours now before they're gone forever.
            </p>
          </div>
        </div>
      </div>
